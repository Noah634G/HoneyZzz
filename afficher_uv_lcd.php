...
if (isset($data['result'][0]['Data'])) {
    ...
    $uv = NettoyerUV($data['result'][0]['Data']); // ILS FAUT CHANGER POUR LA LUM
} else {
    $uv = "Inconnue";
}
